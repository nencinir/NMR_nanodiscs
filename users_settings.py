...
if perform_analysis == 1:
    ...
    parent_folder_path="//home/nenciric/Documents/NMR_paper//corr_func/01_longer/" # A parent folder that contains subfolders with simulations    
    systems=[""]                            # select only systems which folder name contains some of these
    output_path_correlation="//home/nenciric/Documents/NMR_paper//corr_func/01_longer/"   
    output_path_timescales="//home/nenciric/Documents/NMR_paper/NMR_nanodiscs/timescales_akseli_longer/" 
